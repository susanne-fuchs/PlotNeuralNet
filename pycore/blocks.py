...
def block_Pool2Conv( name, botton, top, s_filer=256, n_filer=64, offset="(1,0,0)", size=(32,32,3.5), opacity=0.5 ):
    return [
     to_Pool(         
...
def block_3Conv( name, botton, top, s_filer=256, n_filer=64, offset="(1,0,0)", size=(32,32,3.5), opacity=0.5 ):
    return [
    to_ConvConvRelu(
        name="ccr_{}".format( name ),
        s_filer=str(s_filer),
...
def block_Decode( name, botton, top, s_filer=256, n_filer=64, offset="(1,0,0)", size=(32,32,3.5), opacity=0.5 ):
    return [
        to_ConvTranspose( name='transpose_{}'.format(name),
        ...
        to_ConvConvRelu(
            ...
            n_filer=(n_filer,n_filer),
            offset="(0,0,0)",
            to="(transpose_{}-east)".format( name ),
            width=(size[2],size[2]),
            height=size[0],
            depth=size[1],
            ),
